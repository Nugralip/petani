    ...
    <div class="form-group">
      ...
      <div class="form-group">
        ...
        <input type="text" required="required" class="form-control rounded-0" id="exampleFormControlPasswor3" placeholder="Enter Nama" value="{{$mid->nama}}" name="nama">
      </div>
      <div class="form-group">
        <label for="exampleFormControlPasswor3">Alamat</label>
        <input type="text" required="required" class="form-control rounded-0" id="exampleFormControlPasswor3" placeholder="Enter Alamat" value="{{$mid->alamat}}" name="alamat">
      </div>
      <div class="form-group">
