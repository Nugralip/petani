          ...
          <div class="content">                
                  ...
                  <div class="row" style="background-color:white;">
                    ...
                    <tbody>
                      <?php 
                          $no=1;
                          $rute = tampil('berangkat');
                          while($data = mysqli_fetch_array($rute)): ?>
                        <tr>
                        <th scope="col"><?= $no++; ?></th>
                        <th scope="col"><?= $data['tujuan']; ?></th>
                        <th scope="col"><?= $data['waktu']." | ".$data['tgl']; ?></th>
                        <th scope="col"><?= $data['rute']; ?></th>
                        <th scope="col"><?= $data['status']."/".$data['penumpang']; ?></th>
                        <th class="text-center">
                          <a href="" class="btn btn-sm btn-info mb-1"><i class="mdi mdi-border-color"></i></a>
                          <a href="" class="btn btn-sm btn-success mb-1"><i class="mdi mdi-restart"></i></a>
                          <a href="" class="btn btn-sm btn-danger mb-1"><i class="mdi mdi-beaker"></i></a>
                        </th>
                        </tr>
                        <?php endwhile;?>
                    </tbody>
